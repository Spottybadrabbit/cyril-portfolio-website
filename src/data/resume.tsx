...
export const DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      image: "/agentsinthewild-preview.png",
      video: "",
    },
    {
      title: "GOLAZO",
      href: "https://golazowtf.vercel.app",
      dates: "2026",
      active: true,
      description:
        "A World Cup 2026 fan game built on the live TxLINE feed — every tick is a matchday. " +
        "Four loops on one heartbeat: a Hi-Lo streak game on win probability and attack pressure, collectible card packs that mint as compressed NFTs on mainnet, a friends' squad sweepstake settled live from the feed, and PunditBot narrating every twist. " +
        "Built for the Superteam × TxODDS World Cup hackathon, Consumer and Fan Experiences track.",
      technologies: [
        "Next.js",
        "TypeScript",
        "Convex",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/Spottybadrabbit/golazo",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "/golazo-preview.jpg",
      video: "",
    },
    {
      title: "Squanchy",
